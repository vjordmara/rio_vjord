  ...
  <body>
    ...
    <div class="absolute">
      <form action="includes/insert.inc.php" method="POST">
        ...
        <br>
        <input type="number" min=2019 max=2025 name="gy" value="2019">
        <br>
        <input type="number" min=0 max=4.0 step="0.01" name="gpa" value=2.0>
        <input type="number" min=1000000 max=6999999   placeholder="UpdateID" name="u_id" >
        <br>
        <input type="number" min=7000000 max=7000100  name="Advisor" value=7000000>
